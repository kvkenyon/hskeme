...
/* package hskeme-0.1.0.0 */
#ifndef VERSION_hskeme
#define VERSION_hskeme "0.1.0.0"
#endif /* VERSION_hskeme */
#ifndef MIN_VERSION_hskeme
#define MIN_VERSION_hskeme(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hskeme */
...
#define CURRENT_COMPONENT_ID "hskeme-0.1.0.0-inplace-hskeme"
